...
export const SignInPage = () => {
  ...
  return (
    <div className="">
      <img
        src={background}
        className=" bg-cover bg-center absolute h-[100vh] w-full"
      />

      <div
        id="signinDiv"
        className="relative flex flex-col justify-center items-center align-middle pt-[300px]"
      >
        <h1 className="relative md:text-4xl text-3xl font-extrabold text-gray-900 sm:text-5xl sm:leading-none mb-6 text-center">
          Sign in to your account
        </h1>
        <h1 className="relative md:text-2xl text-2xl  text-gray-900 sm:text-5xl sm:leading-none mb-6 text-center">
